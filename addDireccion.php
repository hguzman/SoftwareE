...
if (isset($_POST['submitted'])) {  
	...
	if (preg_match ('/^[A-Z \'.-]{2,40}$/i', $trimmed['descripcion'])) {
 	...
 	if (empty($errors)) {
			    ...
			    // Administrador
				$q = "INSERT INTO direccion ( idPersona, direccion, descripcion) VALUES ( $idPersona, '$direccion', '$descripcion' )";			
			...
			if (mysqli_affected_rows($dbc) == 1) {
				...
				//	echo '<a href="addDireccion.php?idPersona='.$idPersonas .'">¿Vincular Direccion Celular?</a>';  
					...
					echo   '<a href="verDireccion.php?idPersona='.$idPersona.'">Volrer</a>
						 </p>';							
				# ----------------------------------------------------------------------------------------
				$swRegisto="ok";
...
?>
<center>
<form name="t" action="addDireccion.php" method="post" enctype="multipart/form-data">
<br />
<script type="text/javascript" src="js/btn.js"></script>
	...
	<table align="center">
	 <TR>
		...
		<TD align="left"> <input type="text" name="direccion" size="30" maxlength="50" value="<?php if (isset($trimmed['direccion'])) echo 	$trimmed['direccion']; ?>" class="input" /></TD>
	</TR>
